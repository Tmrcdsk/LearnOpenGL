...
int main()
{
	...
	Shader shader("res/shaders/framebuffersVertex.glsl", "res/shaders/framebuffersFragment.glsl");
	Shader screenShader("res/shaders/framebuffersScreenVertex.glsl", "res/shaders/framebuffersScreenFragment.glsl");
