...
int main()
{
	...
	GLfloat borederColor[] = { 1.0, 1.0, 1.0, 1.0 };
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		simpleDepthShader.SetUniformMat4("uLightSpaceMatrix", lightSpaceMatrix);
		...
		// ---------------------------------------------
		debugDepthQuad.Bind();
		debugDepthQuad.SetUniformFloat("uNearPlane", near_plane);
